...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen relative flex items-center justify-center bg-[#0a0a0f] overflow-hidden">
            ...
            <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-purple-500/10 blur-[120px] rounded-full pointer-events-none mix-blend-screen" />
            <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-blue-500/10 blur-[100px] rounded-full pointer-events-none mix-blend-screen" />
            ...
            <div className="w-full max-w-md p-8 relative z-10">
                <div className="text-center mb-10">
                    ...
                    <p className="text-zinc-400">Sign in to your Spendstack account</p>
                </div>
